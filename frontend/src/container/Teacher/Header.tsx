...
const Header: FC<HeaderProps> = ({ setShowSidebar, showSidebar }) => {
      ...
      <div className="px-3 py-3 lg:px-4 lg:pl-3">
          ...
          <div className="flex items-center ">
            <div className="hidden mr-3 mb-1 sm:block">
              ...
              >
                <div
                  ref={dropdown}
                  className="z-50  max-w-sm overflow-hidden text-base bg-white divide-y divide-gray-100 rounded shadow-lg "
                >
                    ...
                    >
                      ...
                      <div className="w-full pl-3">
                        <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                          ...
                          : "Last deadline of quiz is 10th may"
                        </div>
                    ...
                    >
                      ...
                      <div className="w-full pl-3">
                        <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                          ...
                          : "New assessment quiz MERN Stack"
                        </div>
                        <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                          2 hours ago
                        </div>
                    ...
                    >
                      ...
                      <div className="w-full pl-3">
                        <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                          ...
                          : "Quiz are graded you can come 2 check"
                        </div>
                        <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                         2 days ago
                        </div>
                    ...
                    >
                      ...
                      <div className="w-full pl-3">
                        <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                          ...
                          : "Your attendance was marked for biology"
                        </div>
                        <div className="text-xs font-medium text-primary-700 dark:text-primary-400">
                         3 days
                        </div>
           ...
           <span className=" text-base font-medium capitalize"> {user?.role}, </span>    {" "}     {user?.full_name}
              </CardDescription>
              <div>
             <DropdownMenu>
        ...
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem>
           ...
           <DropdownMenuItem onClick={()=>{ logout(); Navigate('/teacher-login')}} >
