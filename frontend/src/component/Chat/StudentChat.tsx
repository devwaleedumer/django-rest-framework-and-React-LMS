...
import { useGetAllChatQuery, useGetTeacherByIdQuery, useSendChatMutation } from '../../redux/features/user/userApi'
...
const StudentChat = () => {
   ...
   const {data:studentData} =useGetTeacherByIdQuery(teacherId ,{
      
   })

   const {data:chatData} = useGetAllChatQuery({studentId:user?.studentId,teacherId: teacherId  },{
   ...
   const sendMessage = async () => {
      setMessage("")
        ...
        formData.append("student", user.studentId)
