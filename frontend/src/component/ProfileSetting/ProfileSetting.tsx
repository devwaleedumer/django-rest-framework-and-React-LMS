...
import { useGetTeacherByUserQuery } from "../../redux/features/course/courseApi";
...
const formSchema = z
  .object({
    ...
    id: z.number(),
    password: z.nullable(z.string()).optional().or(z.string()
      .regex(/[0-9]/, getCharacterValidationError("digit"))
      .regex(/[a-z]/, getCharacterValidationError("lowercase"))
      .regex(/[A-Z]/, getCharacterValidationError("uppercase"))).optional().or(z.null()),
    confirmPassword: z.nullable(z.string())
      .optional().or(z.string()
      .min(8, "Confirm Password must contain at least 8 character(s)")).optional().or(z.null()),
    phone_no: z
      .string()
      .regex(/[0-9]/, getCharacterValidationError("digit"))
...
const ProfileSetting = () => {
  ...
  const { data: teacherData } = useGetTeacherByUserQuery();
  ...
  useEffect(() => {
    if (teacherData) {
      setValue("phone_no", teacherData.phone_no || "");
      setValue("qualification", teacherData.qualification || "");
      setValue("skills", teacherData.skills || "");
    }
                      ...
                      <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                        <label htmlFor="profile_picture">
                          ...
                          <Avatar className="h-32 w-32">
                            <AvatarImage
                              src={!image ? serverBaseURL + user.profile_picture: image}
                              alt={`Profile Picture`}
                            />
