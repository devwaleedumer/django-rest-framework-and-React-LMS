...
!isLoading ? <section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto min-w-3xl  lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <Link to="/student-login" className="inline-flex text-white bg-primary hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">Login</Link>
        </div>   
    </div>
</section> : 
...
export default StudentAccountConfirmation