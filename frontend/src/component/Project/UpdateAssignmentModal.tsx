...
import { Assignment } from "./column";
import { ACCEPTED_File_TYPES } from "../../utils/options/fileConfiguration";
import moment from "moment";
import { useAppSelector } from "../../redux/hooks";
import { useUpdateAssignmentMutation } from "../../redux/features/Assessments/Assignments/assignmentApi";
...
const UpdateAssignmentModal: FC<Props> = ({ assignment }) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      to_time: moment(assignment?.to_time).format("YYYY-MM-DDTHH:mm"),
        ...
        <Form {...form}>
          ...
          >
            ...
            <div>
              ...
              <FormDescription>
               {assignment.assessment_material_url.split("/assessment/")[1]}
              </FormDescription>
            </div>
