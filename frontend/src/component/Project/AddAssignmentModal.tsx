...
import { useCreateAssignmentMutation } from "../../redux/features/Assessments/Assignments/assignmentApi";
...
const AddAssignmentModal = () => {
  ...
  const [AddAssignment, { isLoading, error, data, isSuccess }] =
  ...
  useEffect(() => {
    if (isSuccess) {
      toast.success("success", {
        description:`Assignment ${data.title} created successfully`,
      });
    }
    if (error) {
      if ("data" in error) {
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Assignment title" type="text" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
