...
import { useCreateQuizMutation } from "../../redux/features/Assessments/Quiz/quizApi";
...
const AddQuizModal = () => {
  ...
  const [AddQuiz, { isLoading, error, data, isSuccess }] =
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit((data) => onSubmitAsync(data))} className="space-y-4 md:space-y-6">
            <DialogHeader>
              ...
              <DialogDescription>Add Quiz details</DialogDescription>
            </DialogHeader>
             ...
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Quiz title" type="text" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
