...
import { Quiz } from "./column";
import { ACCEPTED_File_TYPES } from "../../utils/options/fileConfiguration";
import moment from "moment";
import { useAppSelector } from "../../redux/hooks";
import { useUpdateQuizMutation } from "../../redux/features/Assessments/Quiz/quizApi";
...
const UpdateQuizModal: FC<Props> = ({ quiz }) => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      to_time: moment(quiz?.to_time).format("YYYY-MM-DDTHH:mm"),
        ...
        <Form {...form}>
          ...
          >
            ...
            <div>
              ...
              <FormDescription>
               {quiz.assessment_material_url.split("/assessment/")[1]}
              </FormDescription>
            </div>
