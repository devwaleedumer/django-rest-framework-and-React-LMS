...
SECRET_KEY = 'django-insecure-w)(@u10alke=oab4pu(s8hbb%n#b-hn42-(ra!3c$0pxh^6l&l'
...
ASGI_APPLICATION = 'lms_api.asgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the SF LMS",

    # Copyright on the footer
    "copyright": "SF LMS Ltd",
